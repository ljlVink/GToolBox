...
window.onload = function () {
  ...
  function initialize() {
    ...
    setTimeout(() => {
      ...
      try {
        // Restore HDC Shell Startup Logo
        term.writeln("HDC Shell is starting...\r\n\r\n");
...
function setupEventListeners() {
  ...
  // 2. Resize -> Notify Native (DISABLED: device doesn't support resize)
  // term.onResize(size => {
      ...
      (match, param) => {
        ...
        switch (param) {
          ...
          case "0":
            return "\0";
          default:
            return param; // For \' \" \\ and others, just return the char
        }
      },
    );
